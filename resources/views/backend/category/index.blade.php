      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="template-demo">
            <a href="{{route('add.category')}}"> <button type="button" class="btn btn-primary btn-fw" style="float:right; margin-bottom:15px;">+ Add Category</button></a>
          </div>
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th> Category Turkish </th>
                  <th> Action </th>
                </tr>
              </thead>
              <tbody>
                <?php $i=0  ?>
                @foreach($category as $row) <?php $i++ ?>
                <tr>
                  <td> {{$i}} </td>
