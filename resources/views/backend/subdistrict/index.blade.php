        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="template-demo">
              <a href="{{route('add.subdistrict')}}"> <button type="button" class="btn btn-primary btn-fw" style="float:right; margin-bottom:15px;">+ Add Sub-District</button></a>
            </div>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th> Sub-District Turkish </th>
                    <th> Action </th>
                  </tr>
                </thead>
                <tbody>
                  <?php $i=0  ?>
                  @foreach($subdistrict as $row) <?php $i++ ?>
                    <tr>
                      <td> {{ $i++ }} </td>
