        ...
        <form class="forms-sample" action="{{ route('update.post',$post->id ) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="exampleInputName1" name="title_tr" value="{{ $post->title_tr }}">
            </div>
          </div> <!-- End Row  -->
          <div class="row">
            <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" id="exampleInputName1" name="tags_tr" value="{{ $post->tags_tr }}">
                            </div>
                          </div> <!-- End Row  -->
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="details_tr" id="summernote1">
                              {{ $post->details_tr }}
                            </textarea>
                          </div>
                          <hr>
