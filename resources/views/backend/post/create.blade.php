        ...
        <div class="card-body">
          ...
          <form class="forms-sample" action="{{ route('store.post') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label for="exampleInputName1">Title Turkish</label>
                <input type="text" class="form-control" id="exampleInputName1" name="title_tr">
              </div>
            </div> <!-- End Row  -->
            <div class="row">
              <div class="form-group col-md-6">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label for="exampleInputName1">Tags Turkish</label>
                <input type="text" class="form-control" id="exampleInputName1" name="tags_tr">
              </div>
            </div> <!-- End Row  -->
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="exampleTextarea1">Details Turkish</label>
              <textarea class="form-control" name="details_tr" id="summernote1"></textarea>
            </div>
            <hr>
