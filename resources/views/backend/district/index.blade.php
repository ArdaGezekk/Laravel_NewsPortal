      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="template-demo">
            <a href="{{route('add.district')}}"> <button type="button" class="btn btn-primary btn-fw" style="float:right; margin-bottom:15px;">+ Add District</button></a>
          </div>
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th> District Turkish </th>
                  <th> Action </th>
                </tr>
              </thead>
              <tbody>
                <?php $i=0  ?>
                @foreach($district as $row) <?php $i++ ?>
                <tr>
                  <td> {{$i}} </td>
